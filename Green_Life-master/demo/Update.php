     ...
     <div class="row">
	    <div class="col-2">
		 ...
		 <div class="col-2">
			  ...
			  <div class="form-btn">
			    <span><b>Employee Update</b></span>
			   
			  </div>
			  <form action="" method="post">
			
                <span style="font-size:12" >Select Employee</span>
                 <select class="cmb" name="uname" value ="<?php echo $byear?>">
					<option disabled selected>Employee names</option>
					<option>Shaan</option>
					<option>Hasib</option>
			    ...
			    <button type="submit" class="btn" name ="update" value="Update">Update</button><br>
